...
import { arrayOfString, taskCountType } from 'types';
import { test } from '../../fixtures/authFixture';

const taskListFilters: arrayOfString = ['Assignee', 'Status', 'Label'];
const taskFormFields: arrayOfString = ['Assignee', 'Title', 'Status', 'Label'];
const increasedTaskCount: taskCountType = 16;
const decreasedTaskCount: taskCountType = 14;
